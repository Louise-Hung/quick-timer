...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, wave, newAudio, soundToggle, formatTime, updateWave, updateDisplay, show, adjust, toggle, reset, blink, count, run, resize;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
updateWave = function(ms){
  ...
  return wave.style.height = ratio * 100 + "%";
};
